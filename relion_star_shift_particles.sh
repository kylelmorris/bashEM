...
if [[ -z $1 ]] || [[ -z $2 ]] || [[ -z $3 ]] || [[ -z $4 ]] || [[ -z $5 ]] || [[ -z $6 ]] ; then
  ...
  echo ""
  echo "Variables empty, usage is relion_star_shift_particles.sh (1) (2) (3) (4) (5) (6)"
  echo ""
...
do
  ...
  awk '{$R=newrot;$T=newtilt;$P=newpsi;$X=neworix;$Y=neworiy;print}' \
