...
eog run_it"$j"_classes/class_occupancy.png &
eog run_it"$j"_classes/class_occupancy_abs.png &
eog run_it"$j"_classes/class_occupancy_sorted.png &

open run_it"$j"_classes/class_occupancy.png &
open run_it"$j"_classes/class_occupancy_abs.png &
open run_it"$j"_classes/class_occupancy_sorted.png &

##############################################################################################################################
## The following code will split the class average stack and move the top 25 classes into a seperate folder for inspection
##############################################################################################################################
...
classno=$(e2iminfo.py run_it021_classes.mrcs | awk {'print $2'} | sed -n 1p)
#Get top percentile of classes
top=$((classno/100*20))
echo ""
echo "Top 20% of classes:" $top10 "out of" $classno "classes"
echo ""
...
e2proc2d.py run_it"$j"_classes/top/*.mrc run_it"$j"_classes/top/@.png
e2proc2d.py run_it"$j"_classes/topless/*.mrc run_it"$j"_classes/topless/@.png
